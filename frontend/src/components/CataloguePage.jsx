    ...
    <div className="bg-[#fcfbf7] min-h-screen text-[#1a1a1a] font-sans">
      ...
      <section className="max-w-[1400px] mx-auto px-6 lg:px-12 py-10">
        ...
        {loading ? (
          ...
          <div className="py-24 text-center space-y-4 bg-white border border-neutral-200 rounded-xl my-8">
            <h3 className="text-[20px] font-heading font-medium text-neutral-800">No items match your filter</h3>
            <p className="text-[13px] text-neutral-500">Try switching categories or resetting your search parameters.</p>
            <button
              onClick={() => { setSelectedCategory('all'); setPriceRange(5000); }}
              className="px-6 py-2.5 bg-black text-white text-[11px] font-bold uppercase tracking-widest rounded-md"
            >
              Reset Filters
            </button>
          </div>
